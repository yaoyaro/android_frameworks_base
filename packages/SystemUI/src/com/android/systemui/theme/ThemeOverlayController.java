...
import static com.android.systemui.util.qs.QSStyleUtils.isForceLargeHeaderSetting;
import static com.android.systemui.util.qs.QSStyleUtils.isRoundQSSetting;
import static com.android.systemui.util.qs.QSStyleUtils.setForceLargeHeader;
...
public class ThemeOverlayController implements CoreStartable, Dumpable {
    ...
    public void start() {
        ...
        boolean isForceLargeHeader = isForceLargeHeaderSetting(mContext);
        setForceLargeHeader(isForceLargeHeader);
        mSecureSettings.registerContentObserverForUser(
                Settings.Secure.getUriFor(Settings.Secure.QS_FORCE_LARGE_HEADER),
                false,
                new ContentObserver(mBgHandler) {
                    @Override
                    public void onChange(boolean selfChange, Collection<Uri> collection, int flags,
